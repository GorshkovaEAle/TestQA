...
Сценарий:_0602 проверка доступности  поля Контрагент – в случае, если не выбран Партнер (Заказ покупателя) 
...
Сценарий:_0603 проверка заполнения поля Партнер (Заказ покупателя)
	И я закрываю все окна клиентского приложения
	Дано Я открываю навигационную ссылку "e1cib/list/Document.SalesOrder"
	И я нажимаю на кнопку 'Создать'
