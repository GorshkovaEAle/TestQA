...
Функционал: Загрузка вида цен

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

@ТипШага: Загрузка данных
@Описание: Экспортный сценарий, который заполняет справочник вид цен
@ПримерИспользования: И загружаю вид цен
Сценарий: Загружаю вид цен
