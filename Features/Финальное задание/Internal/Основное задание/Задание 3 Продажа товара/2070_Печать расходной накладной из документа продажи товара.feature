...
Сценарий: 2070_Печать расходной накладной из документа продажи товара
	...
	* Сравнение отчета Остатки по складу с макетом основного варианта отчета
		И Табличный документ "SpreadsheetDocument" равен макету "ПечатнаяРасходнаяНакладная" по шаблону			
